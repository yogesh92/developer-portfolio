...
const experiences = [
  ...
  },
  {
    ...
    location: "Bengaluru, India",
    description: [
      "Worked under the Design and Development team to build Language Support for current e-health software to improve outreach for remote healthcare applications using C#",
      "Collaborated with senior developers to refactor existing modules in C#, enhancing code maintainability and scalability",
      "Provided on-call support for system upgrades and critical maintenance, ensuring minimal downtime and consistent performance",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Maintained a commitment to learning and applying evolving frameworks and tools, such as Docker and Kubernetes, to support scalable and efficient development practices",
    ],
